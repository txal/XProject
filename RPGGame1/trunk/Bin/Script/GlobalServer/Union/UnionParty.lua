...
function CUnionParty:PartyListReq(oPlayer)
	...
	Network.PBSrv2Clt(oPlayer:GetSession(), "UnionPartyListRet", {tList=tList})
...
function CUnionParty:RankingReq(oPlayer, nID)
	...
	Network.PBSrv2Clt(oPlayer:GetSession(), "UnionPartyRankingRet", {tList=tList, sKiller=sKiller, nGotExp=nGotExp, nBossLv=nBossLv})
...
function CUnionParty:BossInfoReq(oPlayer, nPartyID)
	...
	Network.PBSrv2Clt(oPlayer:GetSession(), "UnionPartyBossRet", tMsg)
end
...
function CUnionParty:SyncMCList(oPlayer)
	...
	Network.PBSrv2Clt(oPlayer:GetSession(), "UnionPartyMCListRet", {tList=tList})
...
function CUnionParty:StartBattleReq(oPlayer, nID, bAuto)
	...
	Network.PBSrv2Clt(oPlayer:GetSession(), "UnionPartyBattleRet", tMsg)
	self:SyncMCList(oPlayer)
	self:PartyListReq(oPlayer)
	--小红点
	self:CheckRedPoint(oPlayer)
