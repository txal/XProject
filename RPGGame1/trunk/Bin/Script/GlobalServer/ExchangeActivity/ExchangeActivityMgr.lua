...
function CExchangeActivityMgr:Release()
    GetGModule("TimerMgr"):Clear(self.m_nHourTick)
...
function CExchangeActivityMgr:RegHourTimer()
    ...
    self.m_nHourTick = GetGModule("TimerMgr"):Interval(nNextHourTime, function() self:OnHourTimer() end)
        ...
        if nCostSucc then
            ...
            local function UpdateData()
                ...
                if tConf.bIsBroad then
                    ...
                    CUtil:SendNotice(oRole:GetServer(), sStr)
                end
            end
