...
function CBuff:AddBuffAttr(nType, nVal) self.m_tBuffAttr[nType] = math.min(gtGDef.tConst.nMaxInteger, math.max(-gtGDef.tConst.nMaxInteger, (self.m_tBuffAttr[nType] or 0)+nVal)) end
