...
------------Svr2Svr-------------
function Network.RpcSrv2Srv.MarketSellItemReq(nSrcServer, nSrcService, nTarSession, nRoleID,  tSaleItemData, tTaxList)
...
function Network.RpcSrv2Srv.MarketSellItemListReq(nSrcServer, nSrcService, nTarSession, nRoleID,  tSaleItemList, tTaxList)
	local oRole = goPlayerMgr:GetRoleByID(nRoleID)
    if not oRole then return end
