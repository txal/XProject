--客户端->服务器
function Network.CltPBProc.EnterFBTransitSceneReq(nCmd, nServer, nService, nSession, tData)
...
--服务器内部
function Network.RpcSrv2Srv.GetFBTransitSceneMixID(nSrcServer, nSrcService, nTarSession)
    if goFBTransitScene then
