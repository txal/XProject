...
function CAchievements:EachAchieStateReq(nType)
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "AchievementsStateRet", tMsg)
end
...
function CAchievements:InfoReq(nType)
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "AchievementsInfoRet", {tList=tList})
end
...
function CAchievements:AchievementsAwardReq(nType, nID)
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "AchievementsAwardRet", {tList=tList})
