...
function CFashion:SyncFashion(nID)
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "FashionListRet", tMsg)
end
...
function CFashion:FashionMallReq()
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "FashionMallRet", {tList=tList})
end
...
function CFashion:SyncFashionWear()
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "FashionWearRet", {tList=tList})
end
