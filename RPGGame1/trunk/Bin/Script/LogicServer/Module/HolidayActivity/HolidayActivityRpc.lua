--节日活动请求
function Network.CltPBProc.HolidayActAllInfoReq(nCmd, nServer, nService, nSession, tData)
...
-------------------------------------------------学富五车-------------------------------------------
function Network.CltPBProc.AnswerAllInfoReq(nCmd, nServer, nService, nSession, tData)
    local oRole = goPlayerMgr:GetRoleBySS(nServer, nSession)
    if not oRole then return end
...
function Network.CltPBProc.AnswerReq(nCmd, nServer, nService, nSession, tData)
    local oRole = goPlayerMgr:GetRoleBySS(nServer, nSession)
    if not oRole then return end
    local oActAnswer = oRole.m_oHolidayActMgr:GetActByHolidayActType(gtHolidayActType.eAnswers)
    if not oActAnswer or not oActAnswer:GetCanJoin() then
...
------------------------------------------------江湖历练---------------------------------------------
function Network.CltPBProc.ExperienceAcceptReq(nCmd, nServer, nService, nSession, tData)
    local oRole = goPlayerMgr:GetRoleBySS(nServer, nSession)
    if not oRole then return end
...
function Network.CltPBProc.ExperienceCommitReq(nCmd, nServer, nService, nSession, tData)
    local oRole = goPlayerMgr:GetRoleBySS(nServer, nSession)
    if not oRole then return end
    local oExperience = oRole.m_oHolidayActMgr:GetActByHolidayActType(gtHolidayActType.eExperience)
    if not oExperience or not oExperience:GetCanJoin() then
...
------------------------------------------------尊师考验----------------------------------------------
function Network.CltPBProc.TeachTestJoinReq(nCmd, nServer, nService, nSession, tData)
    local oRole = goPlayerMgr:GetRoleBySS(nServer, nSession)
    if not oRole then return end
