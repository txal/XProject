...
function CLeiChong:LCInfoReq()
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "LeiChongInfoRet", tMsg)
end
...
function CLeiChong:LCAwardReq(nID)
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "LeiChongAwardRet", {nID=nID})
	self:LCInfoReq()
	--小红点
...
function CLeiChong:LCGameInfoReq()
	...
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "LCGameInfoRet", tMsg)
end
...
function CLeiChong:LCGameUsePropReq()
	...
	self:MarkDirty(true)
	Network.PBSrv2Clt(self.m_oPlayer:GetSession(), "LCGameUsePropRet", {tList=tList})
	self:LCGameInfoReq()
	--小红点
	self:CheckRedPoint(self.m_oPlayer)
end
