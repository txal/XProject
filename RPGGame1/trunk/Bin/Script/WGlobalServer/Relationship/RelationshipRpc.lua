...
--请求玩家结拜数据
function Network.CltPBProc.BrotherInfoReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
...
--结拜条件检查请求
function Network.CltPBProc.BrotherSwearCheckReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--结拜请求
function Network.CltPBProc.BrotherSwearReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--解除结拜请求
function Network.CltPBProc.BrotherDeleteReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
-----------------------------------------------------------
--玩家情缘数据请求
function Network.CltPBProc.LoverInfoReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--情缘条件检查请求
function Network.CltPBProc.LoverTogetherCheckReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--情缘请求
function Network.CltPBProc.LoverTogetherReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--解除情缘请求
function Network.CltPBProc.LoverDeleteReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
-----------------------------------------------------------
--师徒关系检查请求
function Network.CltPBProc.MentorshipCheckReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--拜师请求
function Network.CltPBProc.MentorshipDealMasterReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--收徒请求
function Network.CltPBProc.MentorshipDealApprentReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--开除徒弟请求
function Network.CltPBProc.DeleteApprenticeReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--叛离师父请求
function Network.CltPBProc.DeleteMasterReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--徒弟晋级(出师)检查请求
function Network.CltPBProc.MentorshipUpgradeCheckReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--徒弟晋级(出师)请求
function Network.CltPBProc.MentorshipUpgradeReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--玩家师徒数据请求
function Network.CltPBProc.MentorshipInfoReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--获取师徒任务信息列表请求
function Network.CltPBProc.MentorshipTaskDataListReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--刷新师徒任务请求
function Network.CltPBProc.MentorshipFlushTaskReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--发布师徒任务请求
function Network.CltPBProc.MentorshipTaskPublishReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--接取师徒任务请求
function Network.CltPBProc.MentorshipTaskAcceptReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--师徒任务战斗请求
function Network.CltPBProc.MentorshipTaskBattleReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--徒弟领取任务奖励请求
function Network.CltPBProc.MentorshipTaskRewardReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--师父领取任务奖励请求
function Network.CltPBProc.MentorshiTaskMasterRewardReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--徒弟领取活跃度奖励请求
function Network.CltPBProc.MentorshipActiveRewardReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--师父领取活跃度奖励请求
function Network.CltPBProc.MentorshipMasterActiveRewardReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--给师父请安请求
function Network.CltPBProc.MentorshipGreetMasterReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--指点徒弟请求
function Network.CltPBProc.MentorshipTeachApprenticeReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--指点徒弟请求
function Network.CltPBProc.MentorshipPublishTaskRemindReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
-----------------------------------------------------------
--有缘简要数据请求
function Network.CltPBProc.BriefRelationshipDataReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
--玩家关系招募喊话请求
function Network.CltPBProc.RoleRelationshipInviteTalkReq(nCmd, nSrcServer, nSrcService, nTarSession, tData)
    local oRole = goGPlayerMgr:GetRoleBySS(nSrcServer, nTarSession)
    if not oRole then return end
...
------------------ Svr2Svr --------------------
function Network.RpcSrv2Srv.MentorshipTaskBattleEndReq(nSrcServer, nSrcService, nTarSession, nRoleID, tData)
    --tData { nTaskID = , bWin = }
...
--同步结拜数据到逻辑服
function Network.RpcSrv2Srv.SyncBrotherCacheReq(nSrcServer, nSrcService, nTarSession, nRoleID)
    local oRole = goGPlayerMgr:GetRoleByID(nRoleID)
    if not oRole then return end
...
--同步情缘数据到逻辑服
function Network.RpcSrv2Srv.SyncLoverCacheReq(nSrcServer, nSrcService, nTarSession, nRoleID)
    local oRole = goGPlayerMgr:GetRoleByID(nRoleID)
    if not oRole then return end
...
--同步师徒数据到逻辑服
function Network.RpcSrv2Srv.SyncMentorshipCacheReq(nSrcServer, nSrcService, nTarSession, nRoleID)
    local oRole = goGPlayerMgr:GetRoleByID(nRoleID)
    if not oRole then return end
