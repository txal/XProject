<?php 
	...
	//预设卡号值
	$cardNO=isset($_COOKIE['newcards_cardNO'])?$_COOKIE['newcards_cardNO']:"";
	
	//预设用户名
	$username=isset($_COOKIE['newcards_username'])?$_COOKIE['newcards_username']:"";
	...
	if(isset($_POST['cardNOsubmit']))//卡号搜索
	{
		...
		{		
			setcookie("newcards_cardNO",trim($_POST['cardNO']));				
			$cardNO=trim($_POST['cardNO']);
			$username="";
			setcookie("newcards_username","",-3600);
		}
	}elseif(isset($_POST['usernamesubmit']))//用户名搜索
	{
		...
		{
			setcookie("newcards_username",trim($_POST['username']));			
			$username=trim($_POST['username']);
			$cardNO="";
			setcookie("newcards_cardNO","",-3600);
