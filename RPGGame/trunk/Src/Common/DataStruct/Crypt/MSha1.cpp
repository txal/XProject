...
static const size_t BLOCK_INTS = 16;  /* number of 32bit integers per MSHA1 block */
static const size_t BLOCK_BYTES = BLOCK_INTS * 4;


static void reset(uint32_t digest[], std::string &buffer, uint64_t &transforms)
{
    /* MSHA1 initialization constants */
    digest[0] = 0x67452301;
    digest[1] = 0xefcdab89;
    digest[2] = 0x98badcfe;
    digest[3] = 0x10325476;
...
/*
 * (R0+R1), R2, R3, R4 are the different operations used in MSHA1
 */
...
void MSHA1::update(const std::string &s)
{
...
void MSHA1::update(std::istream &is)
{
    while (true)
    {
...
std::string MSHA1::from_file(const std::string &filename)
{
