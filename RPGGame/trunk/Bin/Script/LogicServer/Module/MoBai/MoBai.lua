...
function CMoBai:MoBaiReq(nRankID)
	...
	CmdNet.PBSrv2Clt(self.m_oPlayer:GetSession(), "MoBaiRet", {nRankID=nRankID, sTarName=sTarName, nType=gtItemType.eCurr, nID=gtCurrType.eYuanBao, nNum=nYuanBao})
	--小红点
	self:CheckRedPoint()
...
function CMoBai:CheckRedPoint()
	...
	CmdNet.PBSrv2Clt(self.m_oPlayer:GetSession(), "MoBaiRedPointRet", {tList=tList})
end