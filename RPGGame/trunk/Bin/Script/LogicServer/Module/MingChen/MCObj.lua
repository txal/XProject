...
function CMCObj:FengGuanReq()
	...
	if nTarPinJi then
		...
		CmdNet.PBSrv2Clt(self.m_oPlayer:GetSession(), "MCFengGuanRet", {nMCID=self.m_nSysID, nPinJi=self.m_nPinJi})
...
function CMCObj:AttrDetailReq()
	...
	CmdNet.PBSrv2Clt(self.m_oPlayer:GetSession(), "MCAttrDetailRet", tMsg)
end
