...
function CYaoShouTuXi:yaoshouAttacReq(nYaoShouID, nStars)
	...
	--     goRemoteCall:Call("SetYaoShouBattleStatusReq", nServerID, nGlobalLogic, 0, self.m_oRole:GetID(),nYaoShouID, true)
	-- end
	-- goRemoteCall:CallWait("GetYaoShouBattleStatus", fnGetYaoShouBattleStatus,nServerID, nGlobalLogic, 0, self.m_oRole:GetID(),nYaoShouID)
end
...
function CYaoShouTuXi:UpdateMonster()
	...
	local nServerID = self.m_oRole:GetServer()
	local nGlobalLogic = goServerMgr:GetGlobalService(nServerID, 20)
	goRemoteCall:CallWait("UpdateMonsterReq", fnBroadcastYaoShouCallBack, nServerID, nGlobalLogic, 0, self.m_oRole:GetID(),self.m_nCurYaoShouID)
...
function CYaoShouTuXi:JoinYaoShouTuXi()
	...
	goRemoteCall:CallWait("GetYaoShouInfoReq", fnGetYaoShouCallBack, nServerID, nGlobalLogic, 0, self.m_oRole:GetID())
end
