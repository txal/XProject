...
function CDayRecharge:InfoReq()
	...
	CmdNet.PBSrv2Clt(self.m_oPlayer:GetSession(), "DayRechargeInfoRet", tMsg)
end
...
function CDayRecharge:AwardReq(nID)
	...
	CmdNet.PBSrv2Clt(self.m_oPlayer:GetSession(), "DayRechargeAwardRet", {nID=nID, nItemID=nItemID})
