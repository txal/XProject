...
function CMarriageSceneMgr:OnRelease() 
	self.m_oWedding:OnRelease()
	self.m_oOldManItem:OnRelease()
...
function CMarriageSceneMgr:PalanquinRentReq(oRole)
	...
	goRemoteCall:CallWait("MarriageCheckPalanquinRentReq", fnCheckCallback, gnWorldServerID, 
		goServerMgr:GetGlobalService(gnWorldServerID, 110), 0, nRoleID)
end


--非结婚场景所在逻辑服，这个值为nil
goMarriageSceneMgr = goMarriageSceneMgr or CMarriageSceneMgr:Inst()
