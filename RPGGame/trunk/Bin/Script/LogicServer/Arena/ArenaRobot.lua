...
function CArenaRobot:Ctor(nID, nLevel)
	assert(nID and nID > 0 and nID < gnArenaConfRobotIDMax and nLevel, "参数错误")
	self.m_nID = nID
...
function CArenaRobot:GetConf()
	if self.m_nID >= gnArenaConfRobotIDMax then return end 
...
function CArenaRobot:GetObjType() return gtObjType.eRole end
