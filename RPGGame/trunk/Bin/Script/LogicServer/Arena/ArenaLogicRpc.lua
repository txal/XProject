...
------------Svr2Svr-------------
function Srv2Srv.ArenaSysOpenCheckReq(nSrcServer, nSrcService, nTarSession, nRoleID)
...
function Srv2Srv.ArenaBattleCheckReq(nSrcServer, nSrcService, nTarSession, nRoleID, nEnemyID)
	local oRole = goPlayerMgr:GetRoleByID(nRoleID)
	if not oRole then return end
...
function Srv2Srv.ArenaBattleReq(nSrcServer, nSrcService, nTarSession, nRoleID, tEnemyData, nArenaSeason)
	local oRole = goPlayerMgr:GetRoleByID(nRoleID)
	if not oRole then return end
	if oRole:IsInBattle() then
...
function Srv2Srv.AddArenaCoinReq(nSrcServer, nSrcService, nTarSession, nRoleID, nNum, sReason)
...
function Srv2Srv.ArenaAddBattleRewardReq(nSrcServer, nSrcService, nTarSession, nRoleID, tReward)
