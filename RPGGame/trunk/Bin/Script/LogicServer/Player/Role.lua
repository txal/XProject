...
function CRole:GetID()
end

function CRole:GetName()
end

function CRole:GetServer()
end

function CRole:GetAccountID()
end

function CRole:GetAccountName()
end
...
--飘字通知
function CPlayer:Tips(sCont, nServer, nSession)
    assert(sCont)
