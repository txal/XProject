...
function CBattleDupMgr:Ctor()
	...
	self.m_nTick = goTimerMgr:Interval(nDeadBattleDupCheckInterval, function() self:CheckDeadBattleDupTimer() end)
end

function CBattleDupMgr:OnRelease() 
...
function CBattleDupMgr:CreateBattleDup(nType, fnCallback, bRemote, nServerID)
	...
	--副本不在当前逻辑服
		...
		goRemoteCall:CallWait("WCreateBatteDupReq", function(nDupMixID)
...
goBattleDupMgr = goBattleDupMgr or CBattleDupMgr:new()
