...
function CUnionMiracle:MiracleListReq(oPlayer)
	...
	CmdNet.PBSrv2Clt(oPlayer:GetSession(), "UnionMiracleListRet", tMsg)
	--小红点
...
function CUnionMiracle:DonateReq(oPlayer, nMID, nDID)
	...
	if nOrgLv ~= tMiracle.nLv then
		CmdNet.PBSrv2Clt(oPlayer:GetSession(), "UnionMiracleUpgradeRet", {nMID=nMID, nLv=tMiracle.nLv})
		--更新名臣属性
...
function CUnionMiracle:DonateDetailReq(oPlayer)
	...
	CmdNet.PBSrv2Clt(oPlayer:GetSession(), "UnionDonateDetailRet", {tList=tList})
end
