...
function CBrotherRelationMgr:OnRelease()
...
function CBrotherRelationMgr:SyncLogicCache(nRoleID, nSrcServer, nSrcService, nTarSession)
    ...
    goRemoteCall:Call("RoleBrotherUpdateReq", nSrcServer, nSrcService, nTarSession, nRoleID, tData)
end
...
goBrotherRelationMgr = goBrotherRelationMgr or CBrotherRelationMgr:new()
