...
function CRoleArenaInfo:OnScoreChange(nOld, nNew)
    ...
    if nDiffVal ~= 0 then
	    ...
	    -- goRemoteCall:Call("OnTAJJCReq", oRole:GetServer(), goServerMgr:GetGlobalService(oRole:GetServer(),20), 0, self.m_nRoleID, nDiffVal)
	    -- goRemoteCall:Call("OnCBJJCReq", oRole:GetServer(), goServerMgr:GetGlobalService(oRole:GetServer(),20), 0, self.m_nRoleID, nDiffVal)
	    -- goRemoteCall:Call("ArenaScoreChangeReq", oRole:GetServer(), goServerMgr:GetGlobalService(oRole:GetServer(),20), 0, self.m_nRoleID, nNew)
	end
end
