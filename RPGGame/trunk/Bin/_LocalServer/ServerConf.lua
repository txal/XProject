...
gtServerConf=
{
	...
	tGameDB=
	{
		...
		--本服全局数据(排行榜,活动,帮会等)
		["global"]={
			[20]={nServer=gnServerID, sIP="127.0.0.1", nPort=10011,},
		},
		--玩家自身数据
		["user"]={
	...
	--日志MYSQL
	tLogDB={ sIP="192.168.35.250", nPort=3340, sDBName=gsGamePrefix.."_s"..gnServerID, sUserName="root",sPassword="123456",},
	...
	--全局服务
    tGlobalService={ {nServer=gnServerID, nID=20, nPort=10014},},
	--日志服务
    tLogService={ {nServer=gnServerID, nID=30, nWorkers=2} },
	--登录服务
...
{
    tLogicService={
	    {nServer=gnWorldServerID, nID=100, },
	    {nServer=gnWorldServerID, nID=101, },
	    {nServer=gnWorldServerID, nID=102, },
    },
	tGlobalService={
		{nServer=gnWorldServerID, nID=110, },
		{nServer=gnWorldServerID, nID=111, },
	},
}
