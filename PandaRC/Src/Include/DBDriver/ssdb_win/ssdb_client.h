...
public:
	...
	Status                  hsize(const std::string &name, int64_t *ret);
	Status					hkeys(const std::string &name, const std::string &key_start, const std::string &key_end, uint64_t limit, std::vector<std::string> *ret);
	Status					hscan(const std::string &name, const std::string &key_start, const std::string &key_end, uint64_t limit, std::vector<std::string> *ret);
	Status					hdel(const std::string &name, const std::string &key);
	Status					hincr(const std::string &name, const std::string &key, int64_t incrby, int64_t *ret); //by pd
	Status					hclear(const std::string &name, int64_t *ret = NULL); //bypd
